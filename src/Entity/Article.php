...
class Article
{
     ...
     *      min = 2,
     *      max = 255,
     *      minMessage = "The title of this article must be at least {{ limit }} characters long",
     *      maxMessage = "Your title of this article cannot be higher than {{ limit }} characters"
     * )
     */
    private $title;
